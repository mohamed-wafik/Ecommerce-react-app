...
const RegisterPage = () => {
  ...
  const { register: formRegister, isLoadingRegister } = useAuthStore();
  ...
  const renderRegisterInputs = REGISTER_FORM.map(
      ...
      <div className="hidden lg:flex relative flex-col justify-between p-12 overflow-hidden bg-gradient-to-br from-violet-700 via-violet-600 to-indigo-700">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-white text-4xl font-bold leading-tight mb-4">
            Discover
            <br />
            something <span className="text-violet-200 italic">new.</span>
          </h2>
          <p className="text-white/55 text-sm leading-relaxed max-w-xs">
            Join thousands of happy shoppers. Get early access to sales, free
            shipping on your first order, and more.
          </p>
